...
(Build a Decentralized identity system where academic and proffesional credentials can be securely issued and verified - Streamling hiring and reducing fake qualifications)

Team name - HACKAll ( Pawan Kuamar-Team Lead , Shafana Praveen & Satyam Raj - Team Member )
Team ID-UDB-0Y6D
